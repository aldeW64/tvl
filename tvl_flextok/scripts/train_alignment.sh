...
# =============================================================================
# FlexTok alignment training (Register Tokens)
#
# Train FSQ register tokens with global contrastive alignment and mandatory
# rectified-flow reconstruction of frozen VAE latents for both modalities.
#
# Usage:
#   sbatch tvl_flextok/scripts/train_alignment.sh
#   sbatch --export=ALL,PROJECT_DIR=/path/to/tvl,STAGE1_CKPT=/path/to/ckpt,DATASETS_DIR=/path/to/data \
#     tvl_flextok/scripts/train_alignment.sh
#   # or interactively:
#   srun --gres=gpu:1 --mem=32G --time=12:00:00 --pty bash
#   bash tvl_flextok/scripts/train_alignment.sh
# =============================================================================
...
echo "========================================="
echo "FlexTok alignment training"
...
if [ "$ARCHIVE_ARTIFACTS" = "1" ]; then
    ...
    echo "Alignment training complete. Joint checkpoint: $OUTPUT_DIR/$LOG_NAME/checkpoint_best_joint.pth"
fi
